...
axis_title = ['Linear kernel, C=0.001',
              ...
              'Polynomial kernel, C=0.001']
fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(15,10))
fig.suptitle('In-sample accuracy (Militarised Interstate Dispute Data)',fontsize=20)


for clf, ax, title in zip(best_model, axes.flatten(), axis_title):
...
plt.tight_layout()  
plt.savefig('war_in.png', dpi=300)
plt.show()
...
axis_title = ['Linear kernel, C=0.001',
              ...
              'Polynomial kernel, C=0.001']
fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(15,10))
fig.suptitle('Out-of-sample accuracy (Militarised Interstate Dispute Data)',fontsize=20)
...
plt.tight_layout()  
plt.savefig('war_out.png', dpi=300)
plt.show()
#%%

#create confusion matrix for in-sample classification
axis_title = ['Linear kernel, C=0.001 (DEC)',
              'Gaussian kernel, C=5 (DEC)',
              'Sigmoid kernel, C=0.1 (DEC)',
              'Polynomial kernel, C=10 (DEC)']
fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(15,10))
fig.suptitle('In-sample accuracy, DEC (Militarised Interstate Dispute Data)',fontsize=20)


for clf, ax, title in zip(best_model_w, axes.flatten(), axis_title):
    plot_confusion_matrix(clf, 
                          Train_X, 
                          Train_Y,
                          labels=[1, 0],
...
plt.tight_layout()  
plt.savefig('war_in_w.png', dpi=300)
plt.show()
...
axis_title = ['Linear kernel, C=0.001 (DEC)',
              ...
              'Polynomial kernel, C=10 (DEC)']
fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(15,10))
fig.suptitle('Out-of-sample accuracy, DEC (Militarised Interstate Dispute Data)',fontsize=20)
...
plt.tight_layout()  
plt.savefig('war_out_w.png', dpi=300)
plt.show()
...
axis_title = ['Linear kernel, C=0.001',
              ...
              'Polynomial kernel, C=0.001']
fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(15,10))
fig.suptitle('Insample accuracy (Militarised Interstate Dispute Data)',fontsize=20)
...
plt.tight_layout()  
plt.savefig('war_in_pr.png', dpi=300)
plt.show()
...
plt.tight_layout()  
plt.savefig('war_out_pr.png', dpi=300)
plt.show()
#%%
...
axis_title = ['Linear kernel, C=0.001 (DEC)',
              ...
              'Polynomial kernel, C=10 (DEC)']
fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(15,10))
fig.suptitle('Insample accuracy, DEC (Militarised Interstate Dispute Data)',fontsize=20)
...
plt.tight_layout()  
plt.savefig('war_in_pr_w.png', dpi=300)
plt.show()
...
plt.tight_layout()  
plt.savefig('war_out_pr_w.png', dpi=300)
plt.show()
#%%
#Export result
